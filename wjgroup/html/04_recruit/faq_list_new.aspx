			...
			<div id="article">
				<div id="lnb" class="clearfix">
					...
					<ul>
						...
						<li><a href="/html/04_recruit/faq_list_new.aspx">FAQ</a></li>
					</ul>
				</div>
				<div class="section">
					<iframe id="list" width="650" scrolling="no" height="647" frameborder="0" onload="autoResize()" src="http://recruituser.woongjin.com/Faq/FaqList.aspx" name="list"></iframe>
				</div>
			</div>
		</div>
