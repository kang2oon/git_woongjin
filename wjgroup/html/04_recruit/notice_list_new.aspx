			...
			<div id="article">
				<div id="lnb" class="clearfix">
					...
					<ul>
						...
						<li><a href="/html/04_recruit/notice_list_new.aspx">채용공고</a></li>
					</ul>
				</div>
				<div class="section">
					<iframe id="list" width="100%" scrolling="no" height="792" frameborder="0" onload="autoResize()" src="https://recruituser.woongjin.com:4433/Announce/UserAnnounceList.aspx?seq=" name="list"></iframe>
				</div>
			</div>
		</div>
