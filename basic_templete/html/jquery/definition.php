...
<body class="easyui-layout">
	...
	<div data-options="region:'center',title:'jQuery &gt; JQuery 란?'" style="padding:15px">
		<h2>JQuery 란?</h2>
		<p>
		...
		<h2>JQuery 다운로드</h2>
		<div>
			<p>JQuery 주소는 아래와 같습니다.</p>
			<div class="tbox1 mgtopS">홈페이지 : <a href="http://www.jquery.com/" target="_blank">http://www.jquery.com/</a></div>
		</div>
		<div class="mgtopM"></div>
	</div>
