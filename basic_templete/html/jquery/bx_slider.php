...
<head>
	<meta charset="UTF-8">
	<title>BX Slider &gt; Slider &gt; jQuery &gt; 활용소스 템플릿</title>
...
<body class="easyui-layout">
	...
	<div data-options="region:'center',title:'jQuery &gt; Slider &gt; BX Slider'" style="padding:10px 0 0">
		<div class="easyui-tabs" data-options="fit:true,border:false,plain:true">
				<div title="Remark" style="padding:15px">
					<h2>BX Slider</h2>
					<p>
						왜 BX Slider을 사용해야하는가?<br/>
						<ol class="mgleftL">
					...
					<h2>다운로드 및 지원</h2>
					<div>
						<p>BX Slider 공식 사이트</p>
						<div class="tbox1 mgtopS">홈페이지 : <a href="http://bxslider.com/" target="_blank">http://bxslider.com/</a></div>
					</div>
				</div>
